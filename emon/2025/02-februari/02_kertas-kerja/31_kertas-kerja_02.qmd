...
subtitle: "Bulan Februari Tahun 2025"
...
Selamat datang di Kertas Kerja EMON bulan februari 2025.
...
data_presensi <- here("data/Rekap Presensi Satker 1742443029224.xlsx")
...
read_xlsx(data_response) |> 
  janitor::clean_names() |>
  # tanggal surat pemilihan emon februari diterbit
  filter(waktu_mulai >= "2025-03-10") |> 
...
1. Kedisiplinan, diukur dengan jumlahnya pelanggaran ringan, pelanggaran sedang, dan pelanggaran berat pada bulan februari.
...
Dalam aspek kedisiplinan, tidak ada surat pelanggaran yang dikeluarkan tim subbagian umum untuk bulan februari, sehingga semua pegawai mendapatkan poin penuh (a.k.a 3)
...
```{r keputusan}
emon_winner <- "Maria Megachita Da Silva"
```
...
Pegawai tersebut dipilih karena melakukan lebih banyak variasi pekerjaan di bulan Januari **selain dari pekerjaan Teknis**, seperti Pojok Statistik, Statistik Sektoral, dll.
