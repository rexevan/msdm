...
Setelah memberitahu kepada Kepala BPS Kabupaten Sikka, diputuskan bahwa *Employee of the Month* untuk bulan `r bulan` tahun `r tahun` adalah `r emon_winner`. Beliau di pilih karena
