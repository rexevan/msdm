...
subtitle: "Bulan April Tahun 2025"
author: "Wihelmus Wedo dari April Pilar Manajemen SDM"
format: 
  html: default
  pdf:
...
tbl_response_cleaned |>
  ...
  mutate(
    ...
    waktu = waktu |> fx() |> multiply_by(0.3), # bobot 30%
...
*Employee of the Month* untuk bulan `r bulan` tahun `r tahun` adalah `r emon_winner`.