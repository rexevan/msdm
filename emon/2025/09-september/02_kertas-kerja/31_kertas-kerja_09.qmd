...
subtitle: "Bulan September Tahun 2025"
...
tt_tbl <- read_sheet(link_response, sheet = "tugas_tambahan") |>
  select(pegawai = nama_pegawai, tugas_tambahan = params$bulan) |>
...
```
Seperti yang dilihat, terdapat 2 pegawai dengan nilai Indeks EMON tertinggi. 
Setelah diskusi antara penulis dan kepala BPS Kabupaten Sikka, *Employee of the Month* untuk bulan `r params$bulan` tahun `r params$tahun` adalah **Alvino Alexandro Yappy**.
